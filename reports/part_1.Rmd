...
```{r}
parc_tbl %>% 
  filter(property_class_desc == "RESIDENTIAL CONDOS")
...
parc_tbl %>% 
  filter(parcel_number %in% parchist_tbl$PARCELNO)
...
parchist_tbl %>% 
  filter(PARCELNO %in% parc_tbl$parcel_number)
